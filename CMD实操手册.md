# 第02课 响应式与打印：CMD 全流程实操

从 Git clone 领取模板、修改代码，到提交并推送自己的远程仓库。本版专门用于 Windows CMD。PowerShell 版继续保留，选择一种终端，把整条流程做完即可。这里沿用原来的 web-work、kit-02-v12 和个人 p1-portfolio，不另建一套项目。
