...
export async function openCourseDb(env = process.env) {
  ...
  for (const a of seedArticles) await query('INSERT INTO course_articles(slug,title,summary,content_json,tags_json,status,author,published_at) VALUES($1,$2,$3,$4,$5,$6,$7,$8) ON CONFLICT(slug) DO NOTHING', [a.slug,a.title,a.summary,JSON.stringify(a.content),JSON.stringify(a.tags),a.status,a.author,a.publishedAt])
