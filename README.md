...
[Ubuntu 部署注释附录](Ubuntu部署_平台与命令注释.md)：逐步标明 Windows 本机与 Ubuntu 服务器的切换。
...
git clone --single-branch --depth 1 --branch p1-guide-06-v1.2 $repo kit-06-v12
```

每条命令含义见操作命令第7—9页。ZIP备用下载后，将解压所得目录整理为web-work/kit-06-v12，再按PPT继续。不要克隆教师总仓库。
