# 第03课_响应式布局与作品图像：CMD / PowerShell 统一实操

本课使用固定资源 p1-web-20260918-v2.0。学生正常路线继续修改自己的 p1-homepage；各课 starter 是补课参考状态，不直接覆盖个人工程。

效果：https://ffd-p1-web-v2-20260918.netlify.app/lesson-03/
...
本课完成效果：https://ffd-p1-web-v2-20260918.netlify.app/lesson-03/
...
教师资源：p1-kit-v2/starter/lesson-03

自己的工程：web-work/p1-homepage

本课素材：p1-kit-v2/resources

手册：p1-kit-v2/docs/lesson-03.md
...
运行平台：**VS Code 文件编辑区**。位置：**index.html：搜索 portfolio**。

整张图像块在一个链接中；不要嵌套按钮。

```text
<li class="work-card">
  <a href="https://ffd-p2-blog.netlify.app/">
    <div class="work-cover">
      <img src="assets/work-blog.png" alt="博客截图">
    </div>
    <div class="work-copy"><h3>我的博客</h3></div>
  </a>
</li>
```
...
遇到问题：完整替换前先提交上课版本；不替换自己的 index.html。

完成后回到第 11 页。

### PPT 第 11 页：检查 A：读取一条布局规则

运行平台：**浏览器 / VS Code**。位置：**个人工程 p1-homepage**。

搜索 .portfolio-list，找到 display: grid。

repeat(2, minmax(0, 1fr)) 表示两列。

图片 max-width 与 object-fit 避免变形。
...
运行平台：**VS Code 文件编辑区**。位置：**styles.css：搜索 portfolio-list 与 @media**。
