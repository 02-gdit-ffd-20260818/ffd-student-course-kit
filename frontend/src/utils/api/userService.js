...
export const createUserByAdmin = (userData, adminCredentials) => {
  return post('/users/admin/create', { ...userData, ...adminCredentials });
};

export const resetUserPasswordByAdmin = (email, adminCredentials) => {
  return put(`/users/admin/reset-password/${encodeURIComponent(email)}`, adminCredentials);
};
