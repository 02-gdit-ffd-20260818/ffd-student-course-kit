...
当前 v3.0 同时作为 P1—P5 课程作品总入口。生产巡检执行 `npm run smoke:production`，集成发布记录见 `docs/course-final-release.md`。

答辩实施见 `docs/lesson-17-product-defense-guide.md`、`docs/lesson-18-engineering-defense-guide.md`，全部链接见 `docs/final-evidence-index.md`。
