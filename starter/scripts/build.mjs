...
await cp(new URL('projects.json', root), new URL('projects.json', dist))
await cp(new URL('scripts/project-service.mjs', root), new URL('scripts/project-service.mjs', dist))
await cp(new URL('scripts/project-loader.mjs', root), new URL('scripts/project-loader.mjs', dist))
await cp(new URL('scripts/theme-service.mjs', root), new URL('scripts/theme-service.mjs', dist))
